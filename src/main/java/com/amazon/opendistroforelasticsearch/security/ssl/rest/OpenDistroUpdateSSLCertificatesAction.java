...
public class OpenDistroUpdateSSLCertificatesAction extends BaseRestHandler {
    ...
    public OpenDistroUpdateSSLCertificatesAction(final Settings settings, final Path configPath, final RestController controller,
    ...
    protected OpenDistroUpdateSSLCertificatesAction(Settings settings) {
        super(settings);
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        return new RestChannelConsumer() {
            ...
            public void accept(RestChannel channel) throws Exception {
                ...
                try {
                    log.info("bdebjani: updateSSLChannel");
                    SSLRequestHelper.SSLInfo sslInfo = SSLRequestHelper.updateSSLChannel(odsks, settings, configPath, request, principalExtractor);
